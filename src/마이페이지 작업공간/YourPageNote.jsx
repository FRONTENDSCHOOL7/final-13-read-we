...
const YourPageNote = () => {
  return (
    <>
      <Header />
      <section>
        <h3 className="MP">dongdong's Page</h3>
        <div className="BL-box">
          <h3 className="say-hi">dongdong님의 공간에 오신걸 환영해요!</h3>
          <p className="good-weather">
            dongdong님과 소통을 하거나 업데이트 되는 글을 빠르게 보고 싶다면
            팔로우를 해보세요!
          </p>
          <img
            alt="프로필 이미지"
            className="MP-Book"
            src={process.env.PUBLIC_URL + '../images/books2.png'}
          />
        </div>
      </section>
          ...
          <div className="right-list">
            <div class="my-note">
              <div className="left-center">
                ...
                <p class="center">dongdong님의 독서 노트</p>
              </div>
