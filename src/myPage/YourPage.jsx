    ...
    <>
      ...
      <div className={styles.pageWrap}>
        <section className={styles.contentArea}>
          <h2 className={styles.pageTitle}>{myInfo.profile.username}'s Page</h2>
          ...
          <div className={styles['big-container']}>
            ...
            <div className={styles['profile-parent']}>
              <ProfileCardOther
                imgSrc={baseUrl + '/' + myInfo.profile.image.replace(/^.*\//, '')}
              ...
              <div className={styles['right-list']}>
                <div className={styles['my-note']}>
                  <div className={styles['left-center']}>
                    ...
                    <p className={styles.center}>{myInfo.profile.username}님의 독서 노트</p>
                  </div>
                  <p className={styles.right}>총 {postList.post.length}건</p>
                </div> 

                {/* 마이페이지 > 메인 게시물 리스트 */}
                { postList.post.length == 0 ? <EmptyList text1="아직 기록된 독서노트가 없어요" /> :
